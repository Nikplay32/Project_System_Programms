    ...
    internal sealed class DocumentDetailsMigration : ISubMigration
    {
        ...
        public void Up(Migration migration)
        {
            migration.Create.Table(TableName)
                ...
                .WithColumn(DocumentDetail.StatusId).AsInt32().NotNullable().ForeignKey(Tables.DocumentStatus, DocumentStatus.Id)
                .WithColumn(DocumentDetail.IssueDescription).AsString(250).NotNullable()
